...
const handleLeftClick = () => {
  if (props.clickLeft && typeof props.clickLeft === 'function') {
    props.clickLeft()
  } else {
    emit('left-click')
  }
...
const handleRightClick = () => {
  if (props.clickRight && typeof props.clickRight === 'function') {
    props.clickRight()
  } else {
    emit('right-click')
  }
...
<template>
  <div>
    ...
    <div class="button-container">
      <button class="button-3d" @click="handleLeftClick">
      ...
      <button class="button-3d" @click="handleRightClick">
        <div class="button-top">
          <span class="material-icons">❯</span>
        </div>
        <div class="button-bottom"></div>
